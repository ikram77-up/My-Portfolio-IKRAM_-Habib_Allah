...
export const metadata: Metadata = {
  ...
  description:
    "Ikram Habib Allah - Computer and network engineer with a MIAGE specialization, full-stack developer, software development and AI.",
  alternates: {
  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            width={100}
            sizes="100vw"
            className=" bg-primary  rounded-full mt-24 mb-2 h-auto w-[60%] max-w-[13rem] border-4 border-[#9bb7d4] mx-auto"
            alt="Ikram Habib Allah - software engineer   Portfolio"
            priority
          />
          <AnimatedText
           as="h1"
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Ikram Habib Allah"
              >
      ...
      >
        ...
        <SkillsCard skills={skillsUnsorted} />
      </AnimatedSection>
      <AnimatedSection
        direction="left"
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <AnimatedText
            ...
            className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7"
          >
            {pagesConfig.formations.description}
          </AnimatedText>
        </div>
        ...
        <AnimatedText delay={0.4} className="flex justify-center">
          <Link href="/formations">
            <Button variant={"outline"} className="rounded-xl">
              <Icons.chevronDown className="mr-2 h-4 w-4" /> Voir Tous
            </Button>
          </Link>
        </AnimatedText>
      </AnimatedSection>
